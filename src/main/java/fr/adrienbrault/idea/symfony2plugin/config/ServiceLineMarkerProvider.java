...
public class ServiceLineMarkerProvider implements LineMarkerProvider {
    ...
    private void classNameMarker(PsiElement psiElement, Collection<? super LineMarkerInfo<?>> result) {
    ...
    private void entityClassMarker(PsiElement psiElement, Collection<? super LineMarkerInfo<?>> result) {
    ...
    private void repositoryClassMarker(PsiElement psiElement, Collection<? super LineMarkerInfo<?>> result) {
    ...
    private void formNameMarker(PsiElement psiElement, Collection<? super LineMarkerInfo<?>> result) {
    ...
    private void routeAnnotationFileResource(@NotNull PsiFile psiFile, Collection<? super LineMarkerInfo<?>> results) {
